...
const en: NutritionLabels = {
  ...
  positive: {
    ...
    noPositivePoints: "No specific positive nutrition points identified for this product.",
  },
  context: {
...
const hi: NutritionLabels = {
  ...
  positive: {
    ...
    noPositivePoints: "इस उत्पाद के लिए कोई विशिष्ट सकारात्मक पोषण बिंदु पहचाना नहीं गया।",
  },
  context: {
